...
def possible_moves(state):
    ...
    for i in range(1, 5):
        ...
        if TARGETS[amp] == (-1, 2, 4, 6, 8)[i] and all(amp == other for other in state[i][top_index:]):
...
with open('day23/inputd23.txt') as file:
    data = file.read()
